                        ...
                        <div class="scroll">
                            <div class="row">
                                <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                    <img src="{{asset('assets/client/images/k1.jpg')}}" alt="" class="img-fluid">
                                </div>
                            ...
                            <div class="row my-4">
                                <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                    <img src="{{asset('assets/client/images/k2.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                    <img src="{{asset('assets/client/images/k3.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
